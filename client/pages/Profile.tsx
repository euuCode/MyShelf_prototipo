      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Controle notificações e gêneros</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch checked={profile.preferences.notifications} onCheckedChange={async (v) => {
                const updated = await MockApi.updateProfile(user.id, { preferences: { ...profile.preferences, notifications: v } });
                setProfile(updated);
              }} />
            </div>
            <div>
              ...
              <Select value={profile.preferences.favoriteGenres[0]} onValueChange={async (v) => {
                const updated = await MockApi.updateProfile(user.id, { preferences: { ...profile.preferences, favoriteGenres: [v] } });
                setProfile(updated);
              }}>
